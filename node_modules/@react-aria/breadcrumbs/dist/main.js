...
function useBreadcrumbItem(props, ref) {
  let {
    ...
    elementType = 'a'
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(props, ["isCurrent", "isDisabled", "aria-current", "elementType"]);

  let {
    linkProps
  } = useLink(_babelRuntimeHelpersExtends({
...
$ddafcced542afef86083cfed6bc$exports = JSON.parse("{\"breadcrumbs\":\"Breadcrumbs\"}");
...
function useBreadcrumbs(props) {
  let {
    'aria-label': ariaLabel
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(props, ["aria-label"]);

  let formatMessage = useMessageFormatter($a3b7b8d70b74efa641c5c2c503b27e81$var$intlMessages);
  return {
    navProps: _babelRuntimeHelpersExtends({}, filterDOMProps(otherProps, {
      labelable: true
    }), {
