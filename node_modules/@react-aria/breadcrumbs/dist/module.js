 ...
 */
export function useBreadcrumbItem(props, ref) {
  let {
    isCurrent,
    isDisabled,
    ...
    elementType = 'a'
      ...
      otherProps = _babelRuntimeHelpersEsmObjectWithoutPropertiesLoose(props, ["isCurrent", "isDisabled", "aria-current", "elementType"]);

  let {
    linkProps
  } = useLink(_babelRuntimeHelpersEsmExtends({
  ...
  return {
    itemProps: _babelRuntimeHelpersEsmExtends({
...
$d90361384aaec77f7807bb3c5c62b5a2$exports = JSON.parse("{\"breadcrumbs\":\"Brødkrummer\"}");
...
$c7906303dee64b9ea7408608de8a0cb$exports = JSON.parse("{\"breadcrumbs\":\"Morzsamenü\"}");
...
$d57fd6b5b7ed8bbba63ecfdc71928b08$exports = JSON.parse("{\"breadcrumbs\":\"Breadcrumbs\"}");
...
$c26f5fad5cededd87d599b9f971cb914$exports = JSON.parse("{\"breadcrumbs\":\"Miez de pâine\"}");
...
$f5bdc2c6dd93f1f59eb5a8ba7be951d9$exports = JSON.parse("{\"breadcrumbs\":\"Navigačné prvky Breadcrumbs\"}");
...
$dbc6c44fba6a795aa14c27df994c100$exports = JSON.parse("{\"breadcrumbs\":\"Sökvägar\"}");
...
$eef46c35901b7e908f9dd95d6cd395c$exports = JSON.parse("{\"breadcrumbs\":\"İçerik haritaları\"}");
...
// @ts-ignore
const $c68b69687dd7367cc55044f60a0c$var$intlMessages = {
  "ar-AE": _babelRuntimeHelpersEsmInteropRequireDefault($d2a366f9ef6a15581c8f385d812e3e2$exports).default,
  "bg-BG": _babelRuntimeHelpersEsmInteropRequireDefault($f9f9c99937388844ad0bead1bd3585f$exports).default,
  "cs-CZ": _babelRuntimeHelpersEsmInteropRequireDefault($f192850f1579efff51dd56faff116$exports).default,
  "da-DK": _babelRuntimeHelpersEsmInteropRequireDefault($d90361384aaec77f7807bb3c5c62b5a2$exports).default,
  "de-DE": _babelRuntimeHelpersEsmInteropRequireDefault($c35b920d8565cbdbcd55701920c3993$exports).default,
  "el-GR": _babelRuntimeHelpersEsmInteropRequireDefault($fa1fbe238ab9bf2e486f9adc712b3124$exports).default,
  "en-US": _babelRuntimeHelpersEsmInteropRequireDefault($b4f3cb2c289455c29956b19718a4483$exports).default,
  "es-ES": _babelRuntimeHelpersEsmInteropRequireDefault($a2cb32cace4987be0cac5adbab26f3$exports).default,
  "et-EE": _babelRuntimeHelpersEsmInteropRequireDefault($f026400686fc156cbd4c163a7c5$exports).default,
  "fi-FI": _babelRuntimeHelpersEsmInteropRequireDefault($c8786744df6857419a8c32db6996841$exports).default,
  "fr-FR": _babelRuntimeHelpersEsmInteropRequireDefault($a5398fb928a7d679a782c6faa52e3e8$exports).default,
  "he-IL": _babelRuntimeHelpersEsmInteropRequireDefault($a47148d4d9738765550190d928c1$exports).default,
  "hr-HR": _babelRuntimeHelpersEsmInteropRequireDefault($f621d038c75189be0be4f132f6c3$exports).default,
  "hu-HU": _babelRuntimeHelpersEsmInteropRequireDefault($c7906303dee64b9ea7408608de8a0cb$exports).default,
  "it-IT": _babelRuntimeHelpersEsmInteropRequireDefault($f45b84561852c1fcb341b81caa1f8c1f$exports).default,
  "ja-JP": _babelRuntimeHelpersEsmInteropRequireDefault($cceb23a57a4015eb92565c9d69a51f86$exports).default,
  "ko-KR": _babelRuntimeHelpersEsmInteropRequireDefault($c3596c15f32f0ef4e74ae9b268064555$exports).default,
  "lt-LT": _babelRuntimeHelpersEsmInteropRequireDefault($ca55715e7cdd5bd87592aba57be03$exports).default,
  "lv-LV": _babelRuntimeHelpersEsmInteropRequireDefault($b630e8ea2c93677f99892ac5242053e4$exports).default,
  "nb-NO": _babelRuntimeHelpersEsmInteropRequireDefault($e1a31e86616b4a1633f4b5a41336957$exports).default,
  "nl-NL": _babelRuntimeHelpersEsmInteropRequireDefault($d57fd6b5b7ed8bbba63ecfdc71928b08$exports).default,
  "pl-PL": _babelRuntimeHelpersEsmInteropRequireDefault($ae72552922425db75bd15ad733313c3$exports).default,
  "pt-BR": _babelRuntimeHelpersEsmInteropRequireDefault($b1c418c75419654d626acd2e$exports).default,
  "ro-RO": _babelRuntimeHelpersEsmInteropRequireDefault($c26f5fad5cededd87d599b9f971cb914$exports).default,
  "ru-RU": _babelRuntimeHelpersEsmInteropRequireDefault($e93ae8917a534c3e2eec413fe98$exports).default,
  "sk-SK": _babelRuntimeHelpersEsmInteropRequireDefault($f5bdc2c6dd93f1f59eb5a8ba7be951d9$exports).default,
  "sl-SI": _babelRuntimeHelpersEsmInteropRequireDefault($f496feec0cbf7872d6498d44f433229$exports).default,
  "sr-SP": _babelRuntimeHelpersEsmInteropRequireDefault($cc132b0f84216676b0ba95ca836bcc$exports).default,
  "sv-SE": _babelRuntimeHelpersEsmInteropRequireDefault($dbc6c44fba6a795aa14c27df994c100$exports).default,
  "tr-TR": _babelRuntimeHelpersEsmInteropRequireDefault($eef46c35901b7e908f9dd95d6cd395c$exports).default,
  "uk-UA": _babelRuntimeHelpersEsmInteropRequireDefault($c058458278a484711eae6423d5faea7$exports).default,
  "zh-CN": _babelRuntimeHelpersEsmInteropRequireDefault($ac75bd68aa4384fd08b594c88a$exports).default,
  "zh-TW": _babelRuntimeHelpersEsmInteropRequireDefault($e2c147cd213ac3936c165ae720c4372b$exports).default
};
...
export function useBreadcrumbs(props) {
  let {
    'aria-label': ariaLabel
      ...
      otherProps = _babelRuntimeHelpersEsmObjectWithoutPropertiesLoose(props, ["aria-label"]);

  let formatMessage = useMessageFormatter($c68b69687dd7367cc55044f60a0c$var$intlMessages);
  return {
    navProps: _babelRuntimeHelpersEsmExtends({}, filterDOMProps(otherProps, {
      labelable: true
    }), {
